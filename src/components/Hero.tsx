  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Forensic Global{' '}
        <span className="relative whitespace-nowrap text-[#1a3e9c]">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-[#2351cc]/70"
          ...
          <span className="relative">Accounting</span>
        </span>
      </h1>
      ...
      <div className="mt-16 flex flex-col justify-center gap-4 sm:flex-row sm:gap-x-24">
        ...
        <Button href="#services" variant="outline">
          ...
          <span className="ml-3">See our services</span>
        </Button>
      </div>
    </Container>
  )
